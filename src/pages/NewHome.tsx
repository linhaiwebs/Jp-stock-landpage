...
export default function NewHome() {
  ...
  return (
    <div className="min-h-screen bg-pure-black relative" style={{ backgroundImage: 'url(/assets/background copy.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
      <HeroSection
        stockCode={stockCode}
        stockName={stockData?.info.name}
